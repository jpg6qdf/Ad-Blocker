// To update list, delete url_list variable, run script.py, and copy and paste contents from output_file.txt here
// Don't need to make new url_list variable
url_list = [
	'*://*.0-000.store/*',
	'*://*.004809f9da.com/*',
	'*://*.00aaa2d81c1d174.com/*',
